...
const promptForCity = () => {
    rl.question('Enter a city name to get the weather: ', (city) => __awaiter(void 0, void 0, void 0, function* () {
        const weatherData = yield (0, weatherService_1.getWeather)(city);
        if (weatherData) {
